...
public class Controller {
	...
	@GetMapping("/getListaCategorias")
	 public ResponseEntity<List<Categoria>> getListaCategorias() {
		 ...
		 categorias.add(cat);
		 cat = new Categoria("Comida");
		 categorias.add(cat);
		 cat = new Categoria("Moda");
		 categorias.add(cat);
	...
	*/
	@GetMapping("/getListaEmprendimientos")
	 public ResponseEntity<List<Emprendimiento>> getListaEmprendimientos() {
		 ...
		 Emprendimiento emp = new Emprendimiento("https://panaderia22.com", "1234", "Panaderia Hermanos",
				 "Panaderia familiar desde el año 1960", 50.3, 10 );
		 emprendimientos.add(emp);
		 emp = new Emprendimiento("https://zapateria100.com", "1234", "Zapateria Los Hornos",
				 "Arreglamos tus zapatos en menos tiempo de lo que te imaginas", 20.3, 34 );
		 emprendimientos.add(emp);
		 emp = new Emprendimiento("https://cuidamosMascotas.com", "1234", "Amantes de los animales",
